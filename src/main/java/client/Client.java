...
public class Client {
        ...
        switch (message.getType()) {
            ...
            case "match_start":
                Platform.runLater(() -> {
                    ...
                    // Đảm bảo UI đã được load xong trước khi xử lý các message tiếp theo
                });
                break;
            case "kick_result":
                Platform.runLater(() -> {
            ...
            case "rematch_declined":
                ...
                break;
            case "leaderboard":
                List<?> leaderboard = (List<?>) message.getContent();
                Platform.runLater(() -> {
                    if (mainController != null) {
            ...
            case "your_turn":
                ...
                System.out.println("Received your_turn, gameRoomController: " + (gameRoomController != null));
                Platform.runLater(() -> {
                    if (gameRoomController != null) {
                        gameRoomController.promptYourTurn(duration);
                    } else {
                        // Nếu gameRoomController chưa được khởi tạo, đợi một chút rồi thử lại
                        System.out.println("gameRoomController is null, retrying...");
                        Platform.runLater(() -> {
                            if (gameRoomController != null) {
                                gameRoomController.promptYourTurn(duration);
                            } else {
                                System.err.println("gameRoomController still null after retry!");
                            }
                        });
                    }
                });
            ...
            case "goalkeeper_turn":
                ...
                System.out.println("Received goalkeeper_turn, gameRoomController: " + (gameRoomController != null));
                Platform.runLater(() -> {
                    if (gameRoomController != null) {
    ...
    public void showMainUI() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("/GUI/MainUI.fxml"));
            ...
            URL cssLocation = MainController.class.getResource("/GUI/style.css");
            if (cssLocation != null) {
    ...
    public void showLoginUI() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(LoginController.class.getResource("/GUI/LoginUI.fxml"));
            Parent root = loader.load();
            ...
            URL cssLocation = LoginController.class.getResource("/GUI/style.css");
            if (cssLocation != null) {
                scene.getStylesheets().add(cssLocation.toExternalForm());
                System.out.println("CSS file loaded: " + cssLocation.toExternalForm());
            } else {
    ...
    public void showGameRoomUI(String startMessage) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(GameRoomController.class.getResource("/GUI/GameRoomUI.fxml"));
            Parent root = loader.load();
            ...
            URL cssLocation = GameRoomController.class.getResource("/GUI/style.css");
            if (cssLocation != null) {
                scene.getStylesheets().add(cssLocation.toExternalForm());
                System.out.println("CSS file loaded: " + cssLocation.toExternalForm());
            } else {
